...
def add_data():
    ...
    if new_prime_key in main_data:
        ...
        if len(new_name) > 30:
            ...
            for word in new_name_splitted:
                cap_new_name.append (word.capitalize())
            new_name = " ".join(cap_new_name)
        ...
        while True:
            if len(new_disease) > 0:
                cap_new_disease = []
                for word in new_disease:
                    cap_new_disease.append (word.capitalize())
                new_disease = " ".join(cap_new_disease)
                break
            else :
                ...
                while True :
                    ...
                    if len(new_data) == 0:
                        ...
                        if len(new_data) > 30:
                            ...
                            for word in new_data_splitted:
                                cap_new_data.append (word.capitalize())
                            new_data = " ".join(cap_new_data)
                        break
